...
// ✅ VÉRIFICATION DES VARIABLES D'ENVIRONNEMENT CLIENT
if (!process.env.GOOGLE_CLIENT_ID_CLIENT || !process.env.GOOGLE_CLIENT_SECRET_CLIENT) {
  console.error("❌ ERREUR CRITIQUE: Variables Google OAuth CLIENT manquantes!");
  console.error("Ajoutez dans votre fichier .env:");
  console.error("  GOOGLE_CLIENT_ID_CLIENT=votre_client_id");
  console.error("  GOOGLE_CLIENT_SECRET_CLIENT=votre_secret");
  process.exit(1);
}
