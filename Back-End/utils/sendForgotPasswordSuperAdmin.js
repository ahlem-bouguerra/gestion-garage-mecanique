...
export const sendForgotPasswordMailerSuperAdmin = async (to, token) => {
  const resetURL = `${process.env.FRONTEND_URL_SUPERADMIN}/auth/reset-password?token=${token}&email=${to}`;
  const mailOptions = {
