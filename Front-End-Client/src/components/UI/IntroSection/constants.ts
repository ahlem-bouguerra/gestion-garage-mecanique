...
// For desktop
export const desktopHeaderPhrase = ["Introducing GarageLink's Next-", 'Gen Cards'];
export const desktopParagraphPhrase = [
  " Discover GarageLink's latest innovation – our new cards. Elevate your banking",
  'experience with cutting-edge features, security, and unprecedented',
  'convenience.',
];

// For mobile
export const mobileHeaderPhrase = ["Introducing GarageLink's", 'Next-Gen Cards'];
export const mobileParagraphPhrase = [
  " Discover GarageLink's latest innovation – our new cards.",
