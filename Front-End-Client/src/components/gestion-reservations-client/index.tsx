              ...
              {reservations.map(reservation => {
                ...
                return (
                  <div
                    ...
                    className={`group relative p-4 rounded-xl cursor-pointer transition-all duration-300 ${isActive
                  ...
                  >
                    ...
                    <div className="flex items-start gap-3">
                      {/* Avatar du garage */}
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-white font-bold text-lg flex-shrink-0 transition-all duration-300 ${isActive
                      ...
                      <div className="flex-1 min-w-0">
                        {/* Nom du garage */}
                        <h3 className={`font-bold text-base mb-1 truncate transition-colors ${isActive ? 'text-indigo-900' : 'text-gray-900'
                          }`}>
                          {reservation.garageId?.nom || 'Garage'}
                        </h3>
              ...
              <div className="p-6 bg-white border-b border-gray-200 shadow-sm">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="font-bold text-xl text-gray-900">{selectedReservation.garageId?.nom || 'Garage'}</h2>
                      <div className="flex items-center gap-4 mt-1">
                        ...
                        <p className="text-sm text-gray-500 flex items-center gap-1">
                          ...
                          {selectedReservation.garageId?.telephoneProfessionnel}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-3 flex-wrap">
                      <button
                        ...
                        disabled={loading}
                        className={`group px-6 py-3 rounded-2xl text-sm font-semibold transition-all duration-300 disabled:opacity-50 flex items-center gap-2 shadow-lg ${responseData.action === 'accepter_contre_proposition'
                      ...
                      <button
                        ...
                        disabled={loading}
                        className={`group px-6 py-3 rounded-2xl text-sm font-semibold transition-all duration-300 disabled:opacity-50 flex items-center gap-2 shadow-lg ${responseData.action === 'client_contre_proposer'
                      ...
                      <button
                        ...
                        disabled={loading}
                        className={`group px-6 py-3 rounded-2xl text-sm font-semibold transition-all duration-300 disabled:opacity-50 flex items-center gap-2 shadow-lg ${responseData.action === 'annuler'
