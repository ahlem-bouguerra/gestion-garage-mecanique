...
const ProfilePage = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const response = await axios.get('http://localhost:5000/api/get-profile-super-admin', {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        'http://localhost:5000/api/profile/personal/superAdmin',
        formData,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      ...
      await axios.put(
        'http://localhost:5000/api/profile/password/superAdmin',
        passwordData,
        { headers: { Authorization: `Bearer ${token}` } }
      );
